---
title: 'CTR MdM vs MdM-RS-TAMs: initial exploratory analysis and excluding outliers'
...
```{r read_se}
#we will read se object and subset to match experiment 2, set 1
...
meta <- data.frame(replicate =  c(1, 2, 3, 1, 2, 3, 1, 2, 3),
                   treatment = c(rep("CTRL", 3), rep("L1236", 3), rep("L428", 3)))
...
saveRDS(vsd, file = "../data/vsd_mdm.RDS")
saveRDS(dds, file = "../data/dds_mdm.RDS")
```
