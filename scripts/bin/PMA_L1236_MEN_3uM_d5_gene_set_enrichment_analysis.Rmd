---
title: 'PIM inhibition on formation of PMAr-RS-TAMs (RS-PMAr 5 d): gene set enrichment analysis'
...
dds <- readRDS("../data/dds_mem_5d.RDS")
...
for (name in names(fgsea_res[[1]])) {
      write_csv(fgsea_res[[1]][[name]], 
                path = paste0("../data/tables/fgsea/", "fgsea_DMSO_MEN_5d_", name, ".csv"))
}


# for (name in names(fgsea_res[[2]])) {
#       write_csv(fgsea_res[[2]][[name]], 
#                 path = paste0("../data/tables/fgsea/", "fgsea_MDM_CTRLvsL428_", name, ".csv"))
# }
